...
public class RedOutsideSolo extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        encoderDrive(DRIVE_SPEED, 30, 30, 4.0);  // S3: Drive forward 24 Inches with 4 Sec timeout
        encoderStrafe(DRIVE_SPEED,  -47,  47, 5.0);  // S1: Strafe 24 Inches with 5 Sec timeout
            encoderDrive(DRIVE_SPEED, 32, 32, 4.0);  // S3: Drive forward 24 Inches with 4 Sec timeout
        ...
        sleep(3000);
        encoderDrive(.2, 8, 8, 4.0);  // S3: Drive forward 24 Inches with 4 Sec timeout
        encoderDrive(.2, 6, 6, 4.0);  // S3: Drive forward 24 Inches with 4 Sec timeout
        sleep(1500);
